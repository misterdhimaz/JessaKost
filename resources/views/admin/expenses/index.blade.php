<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="font-extrabold text-xl text-gray-900 leading-tight">Pengeluaran & Belanja</h2>
                <p class="text-sm text-gray-400 font-medium">Catat semua pengeluaran operasional dan pemeliharaan kost</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="space-y-6" x-data="{ showModal: false }">
        <div class="flex justify-end">
            <button @click="showModal = true" class="bg-jessa-maroon text-white px-5 py-2.5 rounded-xl font-bold shadow-sm hover:bg-jessa-maroonDark transition-colors flex items-center gap-2">
        ...
        <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden">
            <div class="p-6 border-b border-gray-100 bg-gray-50/50">
                <h3 class="font-extrabold text-gray-900 text-lg">Daftar Pengeluaran</h3>
            </div>
                    ...
                    <tbody class="text-sm font-medium">
                        ...
                        <tr>
                            <td colspan="5" class="p-12 text-center text-gray-500 font-medium">
                                ...
                                <p>Belum ada catatan pengeluaran yang dibuat.</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
